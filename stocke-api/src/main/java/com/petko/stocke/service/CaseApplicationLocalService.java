...
/**
 * Provides the local service interface for CaseApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author petko
 * @see CaseApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CaseApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.petko.stocke.service.impl.CaseApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the case application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CaseApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
