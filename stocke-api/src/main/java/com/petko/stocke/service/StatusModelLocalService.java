...
/**
 * Provides the local service interface for StatusModel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author petko
 * @see StatusModelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StatusModelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.petko.stocke.service.impl.StatusModelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the status model local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StatusModelLocalServiceUtil} if injection and service tracking are not available.
	 */
